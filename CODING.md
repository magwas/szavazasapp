...
- Tests use `@DisplayName` to document the tested behaviour. The description of tested behaviour is about the logic as perceived by the user, not the implementation. This is the ground truth of the functional specification.
...
- Method signatures have at most 4 parameters. If more, a new data unit with relevance to business logic should be invented.
- K&R coding style
- maximum 25 lines of instructions.
